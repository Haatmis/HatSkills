...
```powershell
node .claude/skills/hat3d/scripts/finition.mjs hat3d/<famille>/<slug>
...
*Une exception, le **plan de pose***. La convention Hat3D veut que le modèle
