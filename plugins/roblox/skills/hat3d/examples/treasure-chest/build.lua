--------------------------------------------------------------------
-- CoffreAuTresor — généré par Hat3D depuis model.json
...
animModule.Source = [==[
-- Hat3DAnim — player d'animations généré depuis model.json.
...
print(("[Hat3D] %s construit : %d parts, %s studs, 2 animation(s) — require(model.Hat3DAnim).play(\"Ouvrir\")"):format(
